...
/// Bản đồ dấu Khmer — Premium learning path
...
class _DiacriticalMapScreenState extends State<DiacriticalMapScreen>
  ...
  Color _nodeColor(int idx) {
    const colors = [
      Color(0xFFFFA000), Color(0xFFFF8F00), Color(0xFFF57F17),
      Color(0xFFFFB300), Color(0xFFFFCA28),
    ];
          ...
          child: ClipRect(
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                width: w, height: mapH,
                child: CustomPaint(
                  painter: _DiacriticalMapPainter(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
            ...
            Row(children: [
              Text(item.character, style: GoogleFonts.battambang(
                fontSize: 22.sp, fontWeight: FontWeight.w700, height: 1.2,
                color: locked ? const Color(0xFFB0BEC5) : const Color(0xFF1A202C))),
              SizedBox(width: 6.w),
              Expanded(child: Text(item.name, style: GoogleFonts.battambang(
            ...
            Text(item.description, style: GoogleFonts.plusJakartaSans(
              ...
              color: locked ? const Color(0xFFCFD8DC) : const Color(0xFF9098A9)),
              maxLines: 1, overflow: TextOverflow.ellipsis),
            SizedBox(height: 4.h),
  ...
  Widget _circle(KhmerDiacritical item, Color color, bool done, bool curr, bool locked) {
    if (locked) {
    ...
    return Container(width: _nodeSize, height: _nodeSize,
      ...
      child: Center(child: Text(item.character,
        style: GoogleFonts.battambang(fontSize: 28.sp, fontWeight: FontWeight.w700,
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(height: 8.h),
          Text(item.name, style: GoogleFonts.battambang(
            fontSize: 18.sp, fontWeight: FontWeight.w700, color: const Color(0xFF2D3142))),
          SizedBox(height: 4.h),
          Text(item.romanized, style: GoogleFonts.plusJakartaSans(
            fontSize: 14.sp, fontWeight: FontWeight.w600, color: const Color(0xFF9098A9))),
          SizedBox(height: 12.h),
          Container(
            width: double.infinity,
            padding: EdgeInsets.all(16.w),
            decoration: BoxDecoration(
              color: const Color(0xFFFFF8E1), borderRadius: BorderRadius.circular(16.r)),
            child: Column(children: [
              Text('💡 Chức năng', style: GoogleFonts.plusJakartaSans(
                fontSize: 13.sp, fontWeight: FontWeight.w700, color: const Color(0xFFF57C00))),
              SizedBox(height: 4.h),
              Text(item.description, textAlign: TextAlign.center,
                style: GoogleFonts.plusJakartaSans(
                  fontSize: 14.sp, fontWeight: FontWeight.w600, color: const Color(0xFF5D4037))),
            ])),
          SizedBox(height: 12.h),
...
class _DiacriticalMapPainter extends CustomPainter {
  ...
  _DiacriticalMapPainter({required this.count, required this.width, required this.getX,
