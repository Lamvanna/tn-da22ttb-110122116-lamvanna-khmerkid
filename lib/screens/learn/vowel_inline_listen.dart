...
class VowelInlineListenContent extends StatefulWidget {
  final KhmerVowel vowel;
  final VoidCallback onComplete;
  const VowelInlineListenContent({super.key, required this.vowel, required this.onComplete});
  @override
  State<VowelInlineListenContent> createState() => _S();
}

class _S extends State<VowelInlineListenContent> with SingleTickerProviderStateMixin {
    ...
    return Column(children: [
      Padding(padding: EdgeInsets.only(top: 18.h, bottom: 8.h),
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          SizedBox(width: 8.w),
          Text('Nghe phát âm', style: GoogleFonts.plusJakartaSans(fontSize: 16.sp, fontWeight: FontWeight.w800, color: AppColors.tertiaryDark)),
        ])),
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Container(width: 120.w, height: 120.w,
              decoration: BoxDecoration(shape: BoxShape.circle, color: AppColors.tertiarySurface,
                boxShadow: [BoxShadow(color: AppColors.tertiary.withValues(alpha: 0.12), blurRadius: 24.r, spreadRadius: 4)]),
            ...
            GestureDetector(onTap: _ttsReady ? _play : null,
              child: Container(padding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 6.h),
                decoration: BoxDecoration(color: AppColors.tertiarySurface, borderRadius: BorderRadius.circular(20.r),
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  SizedBox(width: 6.w),
                  Text('Phát âm: "${widget.vowel.pronunciation}"', style: GoogleFonts.plusJakartaSans(
              ...
              child: AnimatedBuilder(animation: _pulseCtrl, builder: (_, __) => Column(children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: List.generate(11, (i) {
                  ...
                  return Container(width: d <= 1 ? 4.w : 3.w, height: h, margin: EdgeInsets.symmetric(horizontal: 1.5.w),
                    decoration: BoxDecoration(color: AppColors.tertiary.withValues(alpha: _isPlaying ? 0.8 : 0.3), borderRadius: BorderRadius.circular(2.r)));
                })),
              ]))),
            SizedBox(height: 8.h),
