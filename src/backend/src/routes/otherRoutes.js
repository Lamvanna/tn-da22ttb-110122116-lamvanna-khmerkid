...
const { uploadImage, uploadAudio, uploadPdf, uploadVideo } = require('../middlewares/upload');
...
uploadRouter.post('/pdf', authorize('admin'), uploadPdf, uploadController.uploadPdf);
uploadRouter.post('/video', authorize('admin'), uploadVideo, uploadController.uploadVideo);
