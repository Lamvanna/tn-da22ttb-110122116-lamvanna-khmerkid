...
const letterCatchQuestions = [
  { gameKey: 'letter_catch', title: 'Bắt chữ: con', prompt: 'Con', answer: 'កូន', choices: ['ក', 'ូ', 'ម', 'ែ', 'ស', 'ា'], additionalData: { consonant: 'ក', vowel: 'ូ', finalConsonant: 'ន' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: mẹ', prompt: 'Mẹ', answer: 'ម៉ែ', choices: ['ម', 'ែ', 'ក', 'ិ', 'ត', 'ូ'], additionalData: { consonant: 'ម', vowel: 'ែ', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: cha', prompt: 'Cha', answer: 'ឪពុក', choices: ['ព', 'ុ', 'ប', 'ី', 'ស', 'ូ'], additionalData: { consonant: 'ព', vowel: 'ុ', finalConsonant: 'ក' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: anh/chị', prompt: 'Anh/Chị', answer: 'បង', choices: ['ប', 'ង', 'ក', 'i', 'ម', 'ូ'], additionalData: { consonant: 'ប', vowel: '', finalConsonant: 'ង' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: em', prompt: 'Em', answer: 'ប្អូន', choices: ['ប', 'ូ', 'ត', 'ី', 'រ', 'ូ'], additionalData: { consonant: 'ប', vowel: 'ូ', finalConsonant: 'ន' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: trường học', prompt: 'Trường học', answer: 'សាលា', choices: ['ស', 'ា', 'ម', 'ា', 'ដ', 'ូ'], additionalData: { consonant: 'ស', vowel: 'ា', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: thầy/cô', prompt: 'Thầy/Cô', answer: 'គ្រូ', choices: ['គ', 'ូ', 'ក', 'ា', 'រ', 'ូ'], additionalData: { consonant: 'គ', vowel: 'ូ', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: sách', prompt: 'Sách', answer: 'សៀវភៅ', choices: ['ភ', 'ៅ', 'ត', 'ា', 'ប', 'ូ'], additionalData: { consonant: 'ភ', vowel: 'ៅ', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: bút', prompt: 'Bút', answer: 'ប៊ិច', choices: ['ប', 'ិ', 'រ', 'ី', 'ន', 'ំ'], additionalData: { consonant: 'ប', vowel: 'ិ', finalConsonant: 'ច' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: bàn', prompt: 'Bàn', answer: 'តុ', choices: ['ត', 'u', 'ក', 'ែ', 'ទ', 'ៅ'], additionalData: { consonant: 'ត', vowel: 'ុ', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: ghế', prompt: 'Ghế', answer: 'កៅអី', choices: ['ក', 'ៅ', 'ក', 'ែ', 'ទ', 'ៅ'], additionalData: { consonant: 'ក', vowel: 'ៅ', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: nước', prompt: 'Nước', answer: 'ទឹក', choices: ['ទ', 'ឹ', 'ទ', 'ៅ', 'ច', 'ា'], additionalData: { consonant: 'ទ', vowel: 'ឹ', finalConsonant: 'ក' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: cơm', prompt: 'Cơm', answer: 'បាយ', choices: ['ប', 'ា', 'ព', 'ី', 'ល', 'ា'], additionalData: { consonant: 'ប', vowel: 'ា', finalConsonant: 'យ' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: táo', prompt: 'Táo', answer: 'ផ្លែប៉ោម', choices: ['ផ', 'ែ', 'ល', 'a', 'ថ', 'ា'], additionalData: { consonant: 'ប', vowel: 'ោ', finalConsonant: 'ម' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: chuối', prompt: 'Chuối', answer: 'ចេក', choices: ['ច', 'េ', 'ថ', 'ា', 'យ', 'ូ'], additionalData: { consonant: 'ច', vowel: 'េ', finalConsonant: 'ក' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: mèo', prompt: 'Mèo', answer: 'ឆ្មា', choices: ['ឆ', 'ា', 'យ', 'ូ', 'ហ', 'ា'], additionalData: { consonant: 'ឆ', vowel: 'ា', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: chó', prompt: 'Chó', answer: 'ឆ្កែ', choices: ['ឆ', 'ែ', 'ហ', 'ា', 'ឈ', 'ឺ'], additionalData: { consonant: 'ឆ', vowel: 'ែ', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: hoa', prompt: 'Hoa', answer: 'ផ្កា', choices: ['ផ', 'ា', 'ឈ', 'ឺ', 'ក', 'ា'], additionalData: { consonant: 'ផ', vowel: 'ា', finalConsonant: '' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: mặt trời', prompt: 'Mặt trời', answer: 'ព្រះអាទិត្យ', choices: ['ទ', 'ិ', 'ក', 'ា', 'ម', 'ា'], additionalData: { consonant: 'ទ', vowel: 'ិ', finalConsonant: 'ត' } },
  { gameKey: 'letter_catch', title: 'Bắt chữ: tạm biệt', prompt: 'Tạm biệt', answer: 'លា', choices: ['ល', 'ា', 'ក', 'ា', 'ម', 'ា'], additionalData: { consonant: 'ល', vowel: 'ា', finalConsonant: '' } }
];
