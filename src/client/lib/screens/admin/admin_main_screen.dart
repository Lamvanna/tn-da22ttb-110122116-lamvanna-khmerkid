      ...
      title: Row(
        ...
        children: [
          Container(
            ...
            child: Icon(_icons[_currentIndex], color: activeColor, size: 18.sp),
          ),
          SizedBox(width: 10.w),
          Flexible(
            child: Text(
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [Color(0xFF0084FF), Color(0xFF9F33FF)],
              ),
            ),
            child: Stack(
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(color: Colors.white.withValues(alpha: 0.25), width: 2.w),
                          boxShadow: [
                            BoxShadow(
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(Icons.shield_rounded, color: Colors.white, size: 12.sp),
                            SizedBox(width: 4.w),
                            Text('Quản trị viên',
                              style: GoogleFonts.plusJakartaSans(
                                fontSize: 10.5.sp,
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                ...List.generate(9, (i) => _drawerItem(i)),
                Padding(
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: selected ? activeColor : AppColors.surfaceContainerLow,
