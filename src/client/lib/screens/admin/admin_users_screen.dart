          ...
          children: [
            ...
            GridView(
              ...
              children: [
                ...
                _buildDetailStatCard('Thành tích đạt', '$totalBadgesCount thành tích', Icons.verified_user_rounded, AppColors.secondary),
                _buildDetailStatCard('Thời gian học', '$studyTimeMinutes phút', Icons.timer_rounded, AppColors.violet),
              ],
            ),
