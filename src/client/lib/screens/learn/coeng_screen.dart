...
class _CoengScreenState extends State<CoengScreen>
  ...
  void _onLessonCompleted() {
    ...
    // Lưu vào ProgressRepository (chạy trực tiếp online/RAM cache)
    ProgressRepository.instance.completeLesson(
      lessonId: lessonId,
      lessonType: 'coeng',
      lessonOrder: _idx,
      stars: 14,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  context.translate('learn.completed_coeng', args: {'character': _lesson.combined}),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                context.translate('learn.coeng_count', args: {'done': _idx + 1, 'total': _lessons.length}),
                                style: GoogleFonts.plusJakartaSans(
                                  fontSize: 20.sp,
                                  fontWeight: FontWeight.w800,
                                  color: Colors.white,
