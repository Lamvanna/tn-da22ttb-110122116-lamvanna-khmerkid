...
class _WritingMapScreenState extends State<WritingMapScreen>
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 12.w),
                  Flexible(child: Text(context.translate('learning_path.writing_title_map'),
  ...
  List<Widget> _buildAllNodes(double w) {
    ...
    for (int i = 0; i < _lessons.length; i++) {
      ...
      final romanizedTitle = lesson.romanized.isNotEmpty
          ? lesson.romanized[0].toUpperCase() + lesson.romanized.substring(1)
          : '';
      final subtitle = '${lesson.character} ($romanizedTitle)';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                Text(
                  context.translate('writing_topics.${lesson.topicKey}'),
            ...
            child: SizedBox(
              ...
              child: curr
                  ? AnimatedBuilder(
                      ...
                      child: _circle(baiNum, lesson, color, done, curr, locked),
                    )
                  : _circle(baiNum, lesson, color, done, curr, locked),
            ),
          ),
        ),
      );
